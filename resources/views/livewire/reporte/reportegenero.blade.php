<div>
    <button type="button" class="btn btn-outline-success mb-2" wire:click.prevent="GenerarExcelGeneroUsuario()">
    ...
    <div class="card">
        <div class="row p-2">
            ...
            <div class="col-lg-3 col-sm-12 mt-2">
                <select wire:model="filtro_genero" class="form-control form-control-sm">
